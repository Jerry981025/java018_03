...
public class RegisterFormController {
	...
	public @ResponseBody Map<String, Object> addMember(@RequestBody Map<String, String> body) {
		...
		System.out.println(saveBean.getmFirstName() + saveBean.getmLastName() + saveBean.getmPassword()
				+ saveBean.getmAddress() + saveBean.getmEmail() + saveBean.getmCellphone()
		...
		if(memberService.saveMember(saveBean) == 0) {
