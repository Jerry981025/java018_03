...
<head>
    ...
    <!-- 連結內容CSS -->
    <link rel="stylesheet" href="../css/iNeedHelp.css">
    <!-- 連結內容JS -->
    <script src="../javaScript//iNeedHelp.js"></script>
<body>
    <!-- 導覽列 -->
    <nav class="navbar navbar-expand-md navbar-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="../LoginHome/LoginHome.html">幫幫忙
                <img src="https://picsum.photos/300/200/?random=2" alt="" width="30" height="25"
                    class="d-inline-block align-text-top">
            </a>
            <!-- 手機版顯示 -->
            <div class="navbar-toggler rounded-circle">
                <img src="https://picsum.photos/50/50/?random=1" class="rounded-circle" data-bs-toggle="collapse"
                    data-bs-target="#offcanvas">
            </div>
            <!-- 桌機版顯示 -->
            <div class="collapse navbar-collapse" id="linkbar">
                <!-- 內容 -->
                <ul class="nav navbar-nav me-auto p-2">
                    <li class="nav-item">
                        <p class="nav-link active m-0 fs-5">提出需求(I need help!)</p>
                    </li>
                    <li class="nav-item">
    ...
    <div class="collapse navbar-collapse bg-light p-2" id="offcanvas">
        ...
        <ul class="navbar-nav me-auto bg-light">
            ...
            <li class="nav-item">
                <p class="nav-link m-0 fs-5 text-dark">提出需求(I need help!)</p>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../ICanHelp/ICanHelp.html">我要幫忙(I can help!)</a>
            </li>
    ...
    <div class="container-fluid row d-flex px-0 mx-0">
        <!-- GoogleMap --> 
        <div class="col col-8 col-md-8 order-1 order-lg-2 d-flex p-0 m-0">
            <img src="https://picsum.photos/300/200/?random=10" class="mapImg">
        </div>

        <!-- 需求表單 -->
        <div class="col col-4 col-md-4 bg-light m-0 py-0 order-2 order-lg-1 mission">
            <!-- <form class="my-3"> -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-xxl-9 px-2 py-1">
                    <input type="text" class="form-control p-0" id="deladd2" placeholder=" 輸入地址">
                </div>
            </div>
            <!-- 需求終點 -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-xxl-9 px-2 py-1">
                    <input type="text" class="form-control p-0" id="recadd2" placeholder=" 輸入地址">
                </div>
            </div>
            <div class="text-center mb-3" style="text-align:center">
                <button id="loadButton" type="button" class="btn btn-success" style="text-align:center ;">
            ...
            <!-- <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne" data-bs-toggle="tooltip" title=""><button
                            class="accordion-button" type="button" data-bs-toggle="collapse"
                            data-bs-target="#panelsStayOpen-collapse1" aria-expanded="true"
                            aria-controls="panelsStayOpen-collapse1">產品細項</button></h2>
                    <div id="panelsStayOpen-collapse1" class="accordion-collapse collapse show"
                        aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body container">
                            <div class="item">
                                <div class="brandDiv input-group mb-1"><span
                                        class="brandSpan input-group-text">品名</span><input id="brand1"
                                        class="brandInput form-control" type="text"></div>
                                <div class="detailDiv input-group mb-1"><span
                                        class="detailSpan input-group-text">產品細項</span><input id="detail1"
                                        class="detailInput form-control" type="text"></div>
                                <div class="quantityDiv input-group mb-1"><span
                                        class="quantitySpan input-group-text">數量</span><input id="quantity1"
                                        class="quantityInput form-control" type="number" min="0"></div>
                                <div class="imgDiv input-group mb-1"><label
                                        class="imgLabel input-group-text">上傳圖片</label><img id="newImg1">
                                    <div id="newImg1662206306033" class="newImg"></div><input
                                        id="upload_img16622063060331" class="form-control" type="file">
                                </div>
                                <div class="deleteDiv"><button id="deleteButton" class="btn btn-secondary"
            ...
            <div class="row mt-2">
                <!-- 跑腿費 -->
                <div style="display: inline" class="col col-xxl-6">
            ...
            <div class="d-flex row">
                ...
                <div class="col col-6 col-lg-12 col-xxl-3">
                    <div class="form-check mx-1 d-flex">
                        <input class="form-check-input" type="radio" name="flexRadioDefault" id="radio" value="到府服務">
            ...
            <div class="input-group input-group-sm mb-3">
                <textarea id="talk" rows="8" cols="100" maxlength="500" placeholder="請輸入任何與此訂單相關的重要資訊，例如地標、物品數量、代付金額等。"
                    id="talk"></textarea>
            </div>
            <p id="feedback"></p>
            <!-- 按鈕 -->
